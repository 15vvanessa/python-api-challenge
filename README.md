...
Sample scatter plot with the linear regression line. You should create the following plots:
...
Humidity map Narrow down the city_data_df DataFrame to find your ideal weather condition. For example:
...
This activity was completed by a group of classmates 
